...
لكن الطريقة الاقرب التي أراها مناسبة تعتمد انه بدلا من تحويل ال json إلى swift objects .. يمكن الاكتفاء بتحويلها ك dictionary .. وترك الـ layout يصل الى المعلومات المطلوبة statically .. ومن ثم تتكيف هى تلقائياً مع أي missing fields.  
